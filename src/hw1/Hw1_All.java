...
// • 請定義一個常數為3.1415(圓周率),並計算半徑為5的圓面積與圓周長
		...
		double r = 5;
		System.out.printf("圓面積=%.4f%n", Math.pow(r, 2) * PI);
		System.out.printf("圓周長=%.4f%n", 2 * r * PI);
...
//   5 + “5”
		...
		System.out.println(5 + 5);   // 兩個數值5相加=10
		System.out.println(5 + '5'); // 數值5與ASCII編碼號碼串接=58
		System.out.println(5 + "5"); // 數值5與字串5串接=55
